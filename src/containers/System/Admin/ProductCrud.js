...
import { getAllPosition, createPosition,updatePosition, deletePosition} from "../../../services/productService";
import ModalUser from "./ModalProduct";
  ...
  render() {
    ...
    return (
      <div className="users-container">
        ...
        <h1 className="mt-3 text-center">Manage product with Aluminum</h1>
        <div className="container">
          <div className="">
            ...
            >
              <i className="fas fa-plus pe-1"></i> Add new product
            </button>
          </div>
